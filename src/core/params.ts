...
class ParamsBuilder implements BuildableAST {
  ...
  /**
   * Update a decorator on the parameter using a callback function with a flexible find condition
  ...
  updateDecorator(
    ...
    // Update the parameter with the new decorator
  ...
  /**
   * Async version of updateDecorator - Update a decorator on the parameter using an async callback function
   * @param findCondition Function to determine which decorator to update (returns true for the target decorator)
